...
// SystemVerilog created from bb_ZTS6MMstv2_B4_sr_0
...
module k0_ZTS6MMstv2_bb_ZTS6MMstv2_B4_sr_0 (
    ...
    // out_o_stall(GPOUT,51)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,52)
