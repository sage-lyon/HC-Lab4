...
// SystemVerilog created from bb_ZTS6MMstv1_B4_sr_1
...
module k0_ZTS6MMstv1_bb_ZTS6MMstv1_B4_sr_1 (
    ...
    // out_o_stall(GPOUT,31)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,32)
