...
// SystemVerilog created from bb_ZTS13MMstv3_cplusd_B2_sr_1
...
module k1_ZTS13MMstv3_cplusd_bb_ZTS13MMstv3_cplusd_B2_sr_1 (
    ...
    // out_o_stall(GPOUT,21)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,22)
