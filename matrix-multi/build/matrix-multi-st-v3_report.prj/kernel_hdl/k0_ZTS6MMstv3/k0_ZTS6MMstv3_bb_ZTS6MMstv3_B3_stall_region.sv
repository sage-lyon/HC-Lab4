...
// SystemVerilog created from bb_ZTS6MMstv3_B3_stall_region
...
module k0_ZTS6MMstv3_bb_ZTS6MMstv3_B3_stall_region (
    ...
    output wire [0:0] out_c0_exe7121077,
    ...
    assign bubble_join_stall_entry_q = in_c0_exe7121077;

    // bubble_select_stall_entry(BITSELECT,12)
    assign bubble_select_stall_entry_b = $unsigned(bubble_join_stall_entry_q[0:0]);

    // dupName_0_sync_out_x(GPOUT,9)@0
    assign out_c0_exe7121077 = bubble_select_stall_entry_b;
