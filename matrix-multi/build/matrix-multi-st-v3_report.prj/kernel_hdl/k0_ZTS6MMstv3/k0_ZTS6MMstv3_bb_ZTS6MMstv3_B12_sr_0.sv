...
// SystemVerilog created from bb_ZTS6MMstv3_B12_sr_0
...
module k0_ZTS6MMstv3_bb_ZTS6MMstv3_B12_sr_0 (
    ...
    // out_o_stall(GPOUT,37)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,38)
