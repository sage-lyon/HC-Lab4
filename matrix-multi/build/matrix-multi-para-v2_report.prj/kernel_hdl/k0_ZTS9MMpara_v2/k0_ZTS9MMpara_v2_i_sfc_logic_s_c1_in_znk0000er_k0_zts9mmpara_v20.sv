...
// SystemVerilog created from i_sfc_logic_s_c1_in_znk2cl4sycl6detail15accessor_commonifli2elns0_6access4modee1024elns3_6targete2014elns3_11placeholdere0ens0_3ext6oneapi22accessor_property_listijeeee17accessorsubscriptili1eeixili1eveerkfm_exit226_i_zts9mmpara_v2s_c1_enter_k0_zts9mmpara_v20
...
module k0_ZTS9MMpara_v2_i_sfc_logic_s_c1_in_znk0000er_k0_zts9mmpara_v20 (
    ...
    wire [0:0] GND_q;
    wire [0:0] VCC_q;
    wire [31:0] i_unnamed_k0_zts9mmpara_v22_out_primWireOut;
    ...
    // i_unnamed_k0_zts9mmpara_v22(BLACKBOX,3)@202
    // out out_primWireOut@205
    k0_ZTS9MMpara_v2_flt_i_sfc_logic_s_c1_in0000j60ocfd0j60ocqd0j60z thei_unnamed_k0_zts9mmpara_v22 (
        .in_0(in_c1_eni2_1_tpl),
        .in_1(in_c1_eni2_2_tpl),
        .out_primWireOut(i_unnamed_k0_zts9mmpara_v22_out_primWireOut),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    // sync_out_aunroll_x(GPOUT,5)@205
    assign out_c1_exi1_0_tpl = GND_q;
    assign out_c1_exi1_1_tpl = i_unnamed_k0_zts9mmpara_v22_out_primWireOut;
